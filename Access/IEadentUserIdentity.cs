...
namespace Eadent.Identity.Access
{
    ...
    {
        (RegisterUserStatus registerStatusId, UserEntity userEntity) RegisterUser(int createdByApplicationId, string userGuidString, Role roleId, string displayName, string eMailAddress, string mobilePhoneNumber, string plainTextPassword, string userIpAddress, decimal googleReCaptchaScore);
